...
export class AuthenticationService {
  ...
  private users=[
    ...
    {username:"user3", password:"1234",roles:['USER']},
    {username:"user4", password:"1234",roles:['USER']},
    {username:"user5", password:"1234",roles:['USER']},
    {username:"user6", password:"1234",roles:['USER']}
  ]
